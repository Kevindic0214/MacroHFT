...
from RL.util.replay_buffer import ReplayBuffer, SequenceReplayBuffer
...
parser.add_argument("--device",type=str,default="mps", help="Device to use: 'cuda:0', 'mps', or 'cpu'")
...
class DQN(object):
    def __init__(self, args):  
        ...
        self.eval_net, self.target_net = subagent_with_conv_patches(self.n_state_1, self.n_state_2, self.n_action, 64).to(self.device), \
                                         subagent_with_conv_patches(self.n_state_1, self.n_state_2, self.n_action, 64).to(self.device)
        self.hardupdate()
