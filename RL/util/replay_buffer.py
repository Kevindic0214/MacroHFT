...
class SequenceReplayBuffer(object):
    ...
    def __init__(self, args, state_dim, state_dim_2, action_dim, seq_len=20):
        ...
        print(f"SequenceReplayBuffer initialized:")
    ...
    def store_transition(self, state, state_trend, previous_action, demo_action, 
                        action, reward, next_state, next_state_trend, 
                        next_previous_action, next_demo_action, terminal):
